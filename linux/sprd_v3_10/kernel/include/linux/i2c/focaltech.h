...
#if 1 // def CONFIG_GST_TP_COMPATIBLE
...
enum ft5x0x_ts_regs {
	...
	FT5X0X_REG_ERR						= 0xa9,
	FT5X0X_REG_CLB						= 0xaa,
	FT5X0X_REG_PROX_SWITCH              = 0xB0,
};
#ifdef TP_PROXIMITY_SENSOR
#define FT5X0X_PROX_OPEN    0x01
#define FT5X0X_PROX_CLOSE   0x00
#define FT5X0X_PROX_NEAR    0xC0
#define FT5X0X_PROX_FAR     0xE0
#endif
