...
static LCM_Init_Code init_data[] = {
     ...
     {LCM_SEND(6),{4,0,0xBC,0x00,0xa0,0x00}},
     {LCM_SEND(6),{4,0,0xBD,0x00,0xa0,0x00}},
     {LCM_SEND(5),{3,0,0xBE,0x00,0x65}},
     ...
     {LCM_SEND(2),{0xF6,0xa0}},
     {LCM_SEND(2),{0x35,0x00}},
     {LCM_SEND(2),{0x36,0x00}},
     {LCM_SEND(5),{3,0,0x44,0x01,0x50}},
     {LCM_SEND(8),{6,0,0xF0,0x55,0xAA,0x52,0x08,0x01}},
...
static struct info_mipi lcd_rm68180_mipi_info = {
	...
	.lan_number = 2,
	.phy_feq = 380*1000,//330-->380 //huafeizhou0728 disturb RF
