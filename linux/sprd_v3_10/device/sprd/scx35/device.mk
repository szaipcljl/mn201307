...
PRODUCT_COPY_FILES += \
	...
	$(PLATDIR)/hall.kl:system/usr/keylayout/hall.kl \
...
ifeq ($(strip $(GST_NOT_SUPPORT_GPS)),true)
PRODUCT_COPY_FILES += \
	frameworks/native/data/etc/handheld_core_hardware_nogps.xml:system/etc/permissions/handheld_core_hardware.xml \
	frameworks/native/data/etc/android.hardware.location.nogps.xml:system/etc/permissions/android.hardware.location.gps.xml
else
PRODUCT_COPY_FILES += \
