...
-include device/sprd/scx35l/BoardConfigCommon.mk
-include device/sprd/scx35l/emmc/BoardConfigEmmc.mk

#ext4 partition
-include device/sprd/sp9832iea_4m_volte/BoardPartitionConfig.mk

# board configs
TARGET_BOOTLOADER_BOARD_NAME := sp9832iea_4m_volte_dt
UBOOT_DEFCONFIG := sp9832iea_4m_volte
KERNEL_DEFCONFIG := sp9832iea_4m_volte_dt_defconfig
UBOOT_CONFIG_PRODUCT := sp9832iea_4m_volte_dt
...
#sc8830g isp ver 0;sc9630 isp ver 1;sp9830iec isp version 2
...
BOARD_HAVE_PLS := EM3071
BOARD_PLS_COMPATIBLE := false


USE_SPRD_HWCOMPOSER  := true

ifneq ($(WCN_EXTENSION),true)
