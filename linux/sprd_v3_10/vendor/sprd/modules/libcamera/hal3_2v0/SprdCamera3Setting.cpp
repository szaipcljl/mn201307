...
const int32_t kavailable_fps_ranges_front[] = {5, 15, 5, 30, 15, 30};//{5, 15, 5, 20, 10, 20, 5, 25, 10, 25, 5, 30, 10, 30};
...
const int32_t kavailable_back_stream_configurations[60][4] = {
	...
	*/
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 2340, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, 1836, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, 1458, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
#endif
	...
	{HAL_PIXEL_FORMAT_BLOB, 4160, 2340, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
	{HAL_PIXEL_FORMAT_BLOB, 3264, 1836, ANDROID_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT},
...
const int64_t kavailable_back_min_frame_durations[60][4] = {
	...
	*/
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4208, 2367, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, 1836, 33331760L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, 1458, 33331760L},
	...
	{HAL_PIXEL_FORMAT_BLOB, 4160, 2340, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 3264, 1836, 33331760L},
	{HAL_PIXEL_FORMAT_BLOB, 2592, 1458, 33331760L},
...
const int64_t kavailable_back_stall_durations[60][4] = {
	...
	*/
	...
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 4160, 2340, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 3264, 1836, 0L},
	{HAL_PIXEL_FORMAT_YCbCr_420_888, 2592, 1458, 0L},
		...
		if (frame_settings.find(ANDROID_CONTROL_AF_REGIONS).count == 5) {
			...
			if(crop_area[0] || crop_area[1] || crop_area[2] || crop_area[3]) {
				if(af_area[2] <= crop_area[0]
					...
					err_flag = false;
					HAL_LOGE("ANDROID_CONTROL_AE_REGIONS af region invalid");
				} else {
