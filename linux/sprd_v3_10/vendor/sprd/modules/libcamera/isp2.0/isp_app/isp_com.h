...
#define ISP_AEM_BIN_SCAL_RATIO 3  //2:4x 3:8x 4:16x 5:32x
...
typedef struct {
	...
	/*binging4awb buffer info*/
	isp_uint isp_b4awb_mem_size;
	isp_uint isp_b4awb_mem_num;
	isp_uint isp_b4awb_phys_addr_array[2];
	isp_uint isp_b4awb_virt_addr_array[2];
