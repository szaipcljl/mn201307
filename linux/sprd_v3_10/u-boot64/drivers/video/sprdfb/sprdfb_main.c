...
static uint32_t lcd_vol_type_to_kernel = 0;

void save_lcd_vol_type_to_kernel(uint32_t vol_type)
{
	lcd_vol_type_to_kernel = vol_type;
}

uint32_t load_lcd_vol_type_to_kernel(void)
{
	return lcd_vol_type_to_kernel;
}

static uint32_t lcd_mode_type_to_kernel = 0;

void save_lcd_mode_type_to_kernel(uint32_t mode_type)
{
	lcd_mode_type_to_kernel = mode_type;
}

uint32_t load_lcd_mode_type_to_kernel(void)
{
	return lcd_mode_type_to_kernel;
}
