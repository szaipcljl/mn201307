...
#else
#define MS_TS_MSG_IC_GPIO_RST   71 //GPIO_TOUCH_RESET //53 //35 
#define MS_TS_MSG_IC_GPIO_INT   72 //GPIO_TOUCH_IRQ   //52 //37
#endif
#endif //CONFIG_ENABLE_TOUCH_PIN_CONTROL
...
#define TOUCH_KEY_MENU_COORDINATE_MAP (TOUCH_KEY_MENU) 
#define TOUCH_KEY_HOME_COORDINATE_MAP (TOUCH_KEY_BACK) 
#define TOUCH_KEY_BACK_COORDINATE_MAP (TOUCH_KEY_HOME)
#define TOUCH_KEY_SEARCH_COORDINATE_MAP (TOUCH_KEY_SEARCH)
#endif
