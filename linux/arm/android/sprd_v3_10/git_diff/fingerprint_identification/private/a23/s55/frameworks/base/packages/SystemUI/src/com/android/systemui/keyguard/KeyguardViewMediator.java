...
//add by hy end		
    ...
    public void onScreenTurnedOff(int why) {
        synchronized (this) {
            ...
            /*SPRD: fix bug 425895 ,Add cancel function for sim pin and puk.@{ */
            KeyguardUpdateMonitor.getInstance(mContext).resetSimUnlockCancel();
            /*SPRD: fix bug 425895 ,Add cancel function for sim pin and puk.@} */
            ...
            if (mExitSecureCallback != null) {
                ...
                //SPRD: fix bug449711 , Can't unlock when use third-lockscreen
                Log.d(TAG,"onScreenTurnedOff     mExternallyEnabled = "+mExternallyEnabled+";  mShowing = "+mShowing);
    ...
    public void setKeyguardEnabled(boolean enabled) {
        synchronized (this) {
            ...
            //SPRD: fix bug449711 , Can't unlock when use third-lockscreen
            Log.d(TAG, "enable =" + enabled + " , mShowing =" + mShowing + " ,mOccluded=" + mOccluded+";isSecure = "+isSecure());
            if (!enabled && mShowing && !mOccluded  && !isSecure()) {
                if (mExitSecureCallback != null) {
    ...
    public void verifyUnlock(IKeyguardExitCallback callback) {
        synchronized (this) {
            ...
            if (shouldWaitForProvisioning()) {
                ...
                /*SPRD:fix bug 465862,The phone is black screen when using third-party wallpaper.@{*/
                if (!mExternallyEnabled) {
                    Log.d(TAG, "Do not verify Unlock and locked.");
                    return;
                }
                /*SPRD:fix bug 465862,The phone is black screen when using third-party wallpaper.@{*/
    ...
    private void doKeyguardLocked(Bundle options) {
        ...
        // SPRD: fixbug453959 Can't unlock sim-pin when use third-lockscreen
        if (!mExternallyEnabled && !isSecure()) {
