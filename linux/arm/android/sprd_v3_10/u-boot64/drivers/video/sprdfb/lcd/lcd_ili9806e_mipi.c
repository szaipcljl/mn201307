...
static LCM_Init_Code init_data[] = { 
	...
	{LCM_SEND(2), {0xA1,0x04}},//01
	{LCM_SEND(2), {0xA2,0x10}},//08
	{LCM_SEND(2), {0xA3,0x0E}},//0e
	{LCM_SEND(2), {0xA4,0x0B}},//08
	{LCM_SEND(2), {0xA5,0x1A}},//19
	{LCM_SEND(2), {0xA6,0x0D}},//0b
	{LCM_SEND(2), {0xA7,0x07}},//0a
	{LCM_SEND(2), {0xA8,0x01}},//02
	{LCM_SEND(2), {0xA9,0x06}},//08
	{LCM_SEND(2), {0xAA,0x0A}},//04
	{LCM_SEND(2), {0xAB,0x05}},//03
	{LCM_SEND(2), {0xAC,0x0B}},//0a
	{LCM_SEND(2), {0xAD,0x32}},//2c
	{LCM_SEND(2), {0xAE,0x27}},//28
	{LCM_SEND(2), {0xAF,0x00}},

	{LCM_SEND(2), {0xC0,0x00}},//00
	{LCM_SEND(2), {0xC1,0x07}},//02
	{LCM_SEND(2), {0xC2,0x0F}},//09
	{LCM_SEND(2), {0xC3,0x12}},//0e
	{LCM_SEND(2), {0xC4,0x09}},//09
	{LCM_SEND(2), {0xC5,0x17}},//19
	{LCM_SEND(2), {0xC6,0x07}},//0a
	{LCM_SEND(2), {0xC7,0x08}},//0a
	{LCM_SEND(2), {0xC8,0x05}},//02
	{LCM_SEND(2), {0xC9,0x0B}},//07
	{LCM_SEND(2), {0xCA,0x03}},//05
	{LCM_SEND(2), {0xCB,0x06}},//04
	{LCM_SEND(2), {0xCC,0x0F}},//0a
	{LCM_SEND(2), {0xCD,0x26}},//2d
	{LCM_SEND(2), {0xCE,0x27}},//28
...
static uint32_t ili9806e_readid(struct panel_spec *self)
{
	...
	for(j = 0; j < 4; j++){
		...
		printk("lcd_ili9806e_mipi read id 0x02 value is 0x%x,0x%x,0x%x!\n", read_data[0],read_data[1],read_data[2]);

		if((0x98 == read_data[0])&&(0x06 == read_data[1])&&(0x04 == read_data[2])){//huafeizhoyu141030 mod
