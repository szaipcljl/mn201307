...
LOCAL_SRC_FILES+= \
	sensor/vcm_dw9714a.c \
	sensor/af_dw9714.c \
	sensor/ov5640/sensor_ov5640_mipi.c \
	sensor/ov5640/sensor_ov5640_mipi_raw.c \
	sensor/ov5670/sensor_ov5670_mipi_raw.c \
	sensor/sp5409/sensor_sp5409_mipi_raw.c \
	sensor/sp5409v/sensor_sp5409v_mipi_raw.c \
	sensor/gc2155/sensor_gc2155_mipi.c \
	sensor/gc2355/sensor_gc2355_mipi_raw.c \
	sensor/gc2235front/sensor_gc2235front_mipi_raw.c \
	sensor/bf2507/sensor_BF2507_mipi_raw.c \
	sensor/gc2365/sensor_gc2365_mipi_raw.c \
	sensor/gc2365front/sensor_gc2365front_mipi_raw.c \
	sensor/gc2355_front/sensor_gc2355_front_mipi_raw.c \
	sensor/gc2355front/sensor_gc2355front_mipi_raw.c \
	sensor/gc2375front/sensor_gc2375front_mipi_raw.c \
	sensor/gc2755/sensor_gc2755_mipi_raw.c \
	sensor/gc5005/sensor_gc5005_mipi_raw.c \
	sensor/gc5024/sensor_gc5024_mipi_raw.c \
	sensor/gc0409/sensor_gc0409_mipi_raw.c \
	sensor/gc030a/sensor_gc030a_mipi_raw.c \
	sensor/gc030a_back/sensor_gc030a_back_mipi_raw.c \
	sensor/gc0409_back/sensor_gc0409_back_mipi_raw.c \
	sensor/bf2205/sensor_BF2205_mipi_raw.c \
	sensor/bf2205_front/sensor_BF2205_front_mipi_raw.c \
	sensor/sp2508/sensor_sp2508_mipi_raw.c \
	sensor/sp2509/sensor_sp2509_mipi_raw.c \
	sensor/sp2509front/sensor_sp2509front_mipi_raw.c \
	sensor/sp0a09/sensor_sp0a09_mipi_raw.c \
	sensor/ov8825/sensor_ov8825_mipi_raw.c \
	sensor/hi544/sensor_hi544_mipi_raw.c \
	sensor/hi553/sensor_hi553_mipi_raw.c \
	sensor/hi255/sensor_hi255.c \
	sensor/sensor_gc0310_mipi.c \
	sensor/sensor_sp0a20_mipi.c \
	sensor/sensor_gc2145_mipi.c \
	sensor/sensor_bf3905_mipi.c \
	sensor/sensor_bf3a20_mipi.c \
	sensor/ov5648/sensor_ov5648_mipi_raw.c \
	sensor/ov13850/sensor_ov13850_mipi_raw.c \
	sensor/ov13850r2a/sensor_ov13850r2a_mipi_raw.c \
	...
	sensor/s5k3m2xxm3/sensor_s5k3m2xxm3_mipi_raw.c \
	sensor/c2590/sensor_c2590_mipi_raw.c \
	sensor/imx214/sensor_imx214_mipi_raw.c \
	sensor/s5k4h5yc/packet_convert.c \
        sensor/sensor_autotest_ov5648_mipi_raw.c \
        sensor/sensor_autotest_ov5670_mipi_raw.c \
        sensor/sensor_autotest_ov13850_mipi_raw.c \
...
LOCAL_SRC_FILES+= \
	...
	sensor/sensor_autotest_ov5670_mipi_raw.c \
	sensor/sensor_autotest_ov8858_mipi_raw.c \
...
ifeq ($(strip $(TARGET_BOARD_CAMERA_FACE_BEAUTY)),true)
	LOCAL_C_INCLUDES += $(LOCAL_PATH)/arithmetic/facebeauty/inc
endif
...
ifneq ($(strip $(TARGET_BOARD_CAMERA_FLASH_HIGH_AE_MEASURE)),false)
...
ifeq ($(strip $(CAMERA_DEV_2_SUPPORT_SIZE)),13M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_DEV_2_SUPPORT_13M
endif

ifeq ($(strip $(CAMERA_DEV_2_SUPPORT_SIZE)),8M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_DEV_2_SUPPORT_8M
endif

ifeq ($(strip $(CAMERA_DEV_2_SUPPORT_SIZE)),5M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_DEV_2_SUPPORT_5M
endif

ifeq ($(strip $(CAMERA_DEV_2_SUPPORT_SIZE)),3M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_DEV_2_SUPPORT_3M
endif

ifeq ($(strip $(CAMERA_DEV_2_SUPPORT_SIZE)),2M)
LOCAL_CFLAGS += -DCONFIG_CAMERA_DEV_2_SUPPORT_2M
endif
...
ifeq ($(strip $(TARGET_BOARD_CAMERA_POLE_SUPPORT)),true)
LOCAL_CFLAGS += -DCONFIG_CAMERA_POLE_SUPPORT
endif
...
ifeq ($(strip $(TARGET_BOARD_CAMERA_HDR_CAPTURE)),true)
	ifeq ($(strip $(TARGET_BOARD_CAMERA_HDR_MORPHO_LIB)),true)
...
LOCAL_SHARED_LIBRARIES += libAF libsft_af_ctrl
...
LOCAL_MODULE_STEM_64 := libAl_Awb.so
LOCAL_SRC_FILES_32 :=  isp2.0/awb/libAl_Awb.so
LOCAL_SRC_FILES_64 :=  isp2.0/awb/libAl_Awb_64.so
...
LOCAL_SRC_FILES_64 :=  isp2.0/awb/libAl_Awb_Sp_64.so
include $(BUILD_PREBUILT)
else
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES_64 :=  oem2v0/isp64/libae.so
include $(BUILD_PREBUILT)
else
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES_32 :=  isp2.0/alc_af/lib/libaf_running.so
LOCAL_SRC_FILES_64 :=  isp2.0/alc_af/lib/libaf_running_64.so
include $(BUILD_PREBUILT)
else
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := isp2.0/alc_af/lib/libaf_running.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
endif
...
LOCAL_SRC_FILES_32 :=  oem2v0/isp/libdeflicker.so
LOCAL_SRC_FILES_64 :=  oem2v0/isp/libdeflicker_64.so
include $(BUILD_PREBUILT)
endif
else
include $(CLEAR_VARS)
