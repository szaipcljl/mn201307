...
#define SNAPSHOT_LINE_TIME		222
#define PREVIEW_LINE_TIME		222
...
#define MODULE_ID_gc5024_yyy		0x0001    //gc5024: sensor P/N;  yyy: module vendor
...
#include "sensor_gc5024_yyy_otp.c"

struct raw_param_info_tab s_gc5024_raw_param_tab[] = {
	{MODULE_ID_gc5024_yyy, &s_gc5024_mipi_raw_info, gc5024_yyy_identify_otp, gc5024_yyy_update_otp},
...
static const SENSOR_REG_T gc5024_init_setting[] = {
	...
	/* BLK */
	{0x40,0x22},
	{0x4e,BLK_VAL_H},//Don't Change Here!!!
	{0x4f,BLK_VAL_L},//Don't Change Here!!!
	{0x60,0x00},
	{0x61,0x80},
	{0xfe,0x02},
	{0xa4,0x30},
...
#define param_update(x1,x2) sprintf(name,"/data/gc5024_%s.bin",x1);\
 ...
 *============================================================================*/
static void gc5024_group_hold_on(void)
{
	SENSOR_PRINT("E");
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc5024_group_hold_off(void)
{
	SENSOR_PRINT("E");
...
static void gc5024_write_gain(uint32_t gain)
{
	...
	{	
		...
		Sensor_WriteReg(0x29, 0x0f); 
		Sensor_WriteReg(0xe8, 0x03); 
		Sensor_WriteReg(0xe9, 0x01); 
		Sensor_WriteReg(0xea, 0x02); 
		Sensor_WriteReg(0xeb, 0x02); 
		Sensor_WriteReg(0xec, 0x03); 
		Sensor_WriteReg(0xed, 0x01); 
		Sensor_WriteReg(0xee, 0x02); 
		Sensor_WriteReg(0xef, 0x02);	
#endif
		//analog gain
...
#if 0
		Sensor_WriteReg(0xfe, 0x00);
		Sensor_WriteReg(0x21, 0x0d);
		Sensor_WriteReg(0x29, 0x1d); 
...
#if 0
		Sensor_WriteReg(0xfe, 0x00);
		Sensor_WriteReg(0x21, 0x08);
		Sensor_WriteReg(0x29, 0x38); 
		Sensor_WriteReg(0xe8, 0x03); 
		Sensor_WriteReg(0xe9, 0x03); 
		Sensor_WriteReg(0xea, 0x03); 
		Sensor_WriteReg(0xeb, 0x03); 
		Sensor_WriteReg(0xec, 0x03); 
		Sensor_WriteReg(0xed, 0x03); 
		Sensor_WriteReg(0xee, 0x03); 
		Sensor_WriteReg(0xef, 0x03); 
#endif
		//analog gain
 ...
 *
 *============================================================================*/
static uint32_t gc5024_get_resolution_trim_tab(uint32_t param)
{
	return (uint32_t) s_gc5024_resolution_trim_tab;
}
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static uint32_t gc5024_set_hdr_ev(uint32_t param)
{
 ...
 *============================================================================*/
static uint32_t gc5024_ext_func(uint32_t param)
{
...
static SENSOR_IOCTL_FUNC_TAB_T s_gc5024_ioctl_func_tab = {
	...
	#endif	
	//.group_hold_on = gc5024_group_hold_on,
	//.group_hold_of = gc5024_group_hold_off,
};
