...
#define SENSOR_STRING_TYPE_ROTATION_MATRIX                     "android.sensor.rotation_matrix"

#define SENSOR_TYPE_ACC_RAW                                    (SENSOR_TYPE_DEVICE_PRIVATE_BASE+16)
#define SENSOR_STRING_TYPE_ACC_RAW                             "android.sensor.acc_raw"

#define SENSOR_TYPE_GYRO_RAW                                    (SENSOR_TYPE_DEVICE_PRIVATE_BASE+17)
#define SENSOR_STRING_TYPE_GYRO_RAW                             "android.sensor.gyro_raw"

#define SENSOR_TYPE_COMPS_RAW                                    (SENSOR_TYPE_DEVICE_PRIVATE_BASE+18)
#define SENSOR_STRING_TYPE_COMPS_RAW                             "android.sensor.comps_raw"
