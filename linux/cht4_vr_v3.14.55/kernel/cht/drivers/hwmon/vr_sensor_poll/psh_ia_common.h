...
#define STRESS_STEP_0_PREAPRE_DATA    10
#define STRESS_STEP_1_SEND_DATA       11
#define STRESS_STEP_2_WAIT_ACK        12
#define STRESS_STEP_3_WAIT_DATA       13

    int is_in_debug;
    int debug_send_count;
    int stress_test_step;
    int stress_test_polling_time;
