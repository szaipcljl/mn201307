...
class SensorDevice {
        ...
        ish_sensor_t ish_sensor_type;
        int mapper[AXIS_MAX];
        float scale[AXIS_MAX];
...
public:
        ...
        ish_sensor_t getIshSensorType() { return ish_sensor_type; }
        void setIshSensorType(ish_sensor_t sensor_type) { ish_sensor_type = sensor_type; }
