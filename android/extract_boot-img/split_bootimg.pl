...
my $BOOT_MAGIC = 'ANDROID!';
my $BOOT_MAGIC_SIZE = 8;
my $BOOT_NAME_SIZE = 16;
my $BOOT_ARGS_SIZE = 512;
...
print "dump cmdline\n";
open OUTF, ">$c_file" or die "Could not open $c_file: $!\n";
print OUTF $cmdline or die "Could not write $c_file: $!\n";
close OUTF;
