 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ticktick_jnicallback_Native_nativeInitilize(JNIEnv *env, jobject thiz) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ticktick_jnicallback_Native_nativeThreadStart(JNIEnv *env, jobject thiz) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ticktick_jnicallback_Native_NativeThreadStop(JNIEnv *env, jobject thiz) {
	gIsThreadExit = 1;
