...
/*--------------------------- Local Data ------------------------------------*/
LOCAL __align(64) uint8_t s_usb_snd_buff[USB_BUFF_SIZE];
/*--------------------------- Global Data -----------------------------------*/
/*--------------------------- External Data ---------------------------------*/
/*----------------------------------------------------------------------------*
...
void usb_init (uint32_t ext_clk26M);
...
void usb_init (uint32_t ext_clk26M)
{   
    *(volatile uint32_t *)REG_AP_AHB_AHB_EB |= BIT_USB_EB;  // usbd enable
    usb_core_init();
}
/*****************************************************************************/
//  Description:
...
//    Note:
/*****************************************************************************/
void usb_boot (uint32_t ext_clk26M)
{
    usb_init (ext_clk26M);
}
