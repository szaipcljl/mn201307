...
Usage:
  sensor list [-a]
  sensor read [-t sensor_type] [-d delay]
  sensor verify [-t sensor_type] [-d delay] [-o verify_option]

Auto Test: (Here's the example in SP8810EA)

/* List sensors */
shell@android:/ # sensor list
sensor -- list
--------------------------------------------------------
sensor -- list
5 sensors found:
...
/* Read sensors */
shell@android:/ # sensor read -t Acc -d 1
--------------------------------------------------------
sensor -- read
...
/* verify sensors */
shell@android:/ # sensor verify -t ACCELEROMETER -d 100 -o show
sensor -- verify
-------------------------------------------------------------
ACCELEROMETER  Verify_option : show
	...
	stability	--	Keep device still in 30s.
	   ...
	   ::   		   ::
-------------------------------------------------------------
shell@android:/ # sensor verify -t ACCELEROMETER -d 100 -o tilt
sensor -- verify
-------------------------------------------------------------
...
Success!
-------------------------------------------------------------
shell@android:/ # sensor verify -t ACCELEROMETER -d 100 -o install_dir
sensor -- verify
-------------------------------------------------------------
...
-->Face up
   ::
-------------------------------------------------------------
shell@android:/ # sensor verify -t ACCELEROMETER -d 100 -o stability
sensor -- verify
-------------------------------------------------------------
