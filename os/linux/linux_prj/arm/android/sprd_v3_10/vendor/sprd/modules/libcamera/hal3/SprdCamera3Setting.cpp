...
/*
	...
	settings.update(ANDROID_SPRD_UCAM_SKIN_LEVEL, &(s_setting[mCameraId].sprddefInfo.perfect_skin_level), 1);
#endif
	...
	settings.update(ANDROID_SPRD_ZSL_ENABLED, &(s_setting[mCameraId].sprddefInfo.sprd_zsl_enabled), 1);
#endif
