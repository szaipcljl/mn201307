...
#if 1
#define  LCD_VOL_MARGIN          299
#define  LCD_VOL_VALUE0			0 // 0V ~0.4v (0v)
#define  LCD_VOL_VALUE1			2800 // 2.4~2.8V (2.8v)
#define  LCD_VOL_VALUE2			800 //0.4~1.2v  (0.8V)
#define  LCD_VOL_VALUE3  		2000 // 1.6v~2.4v (2.0V)
#else
#define  LCD_VOL_MARGIN          299
#define  LCD_VOL_VALUE0			0 // 0V ~0.3v (0v)
#define  LCD_VOL_VALUE1			2800 // 2.5~2.8V (2.8v)
#define  LCD_VOL_VALUE2			600 //0.3~0.9v  (0.6V)
#define  LCD_VOL_VALUE3  		1600 // 1.3v~1.9v (1.6V)
#endif
...
#if defined(CONFIG_LCD_COMPATIBLE_BY_READ_ID_VOLTAGE)
	int32_t (*panel_get_vol_type)(struct panel_spec *self, uint32_t vol_type);
#endif
};
