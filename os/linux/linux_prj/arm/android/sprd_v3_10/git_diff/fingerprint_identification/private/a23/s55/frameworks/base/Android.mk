...
FM_SRC_DIR := core/java/android/hardware/fm/ \
LOCAL_SRC_FILES += $(call find-other-java-files,$(FM_SRC_DIR))
...
LOCAL_SRC_FILES += \
    ...
    telephony/java/com/android/internal/telephony/IGlobalConfig.aidl \
    telephony/java/com/android/internal/telephony/IOnMccMncChangedListener.aidl \
