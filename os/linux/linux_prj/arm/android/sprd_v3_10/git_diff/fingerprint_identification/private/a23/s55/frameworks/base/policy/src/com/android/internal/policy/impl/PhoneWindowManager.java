...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public int prepareAddWindowLw(WindowState win, WindowManager.LayoutParams attrs) {
        switch (attrs.type) {
            ...
            case TYPE_NAVIGATION_BAR:
                ...
                /* work around for Screen Pinning test @{ */
                if (mForceNavigationBarShow) {
                    mNavigationBarController.setBarShowingLw(false, true);
                }
                /* @} */
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        /*SPRD: Open debug log.
         * There is a log that is seriously repeated except the action of keycode is false,
         * so do not print it in slog, for the reason of cutting slog @{ */
        //if (DEBUG_INPUT) {
	...
	/* @} */
        ...
        if (down && repeatCount == 0 && !keyguardOn) {
            ...
            if (category != null && !ignorSpecialKey(keyCode)) {
    ...
    public void beginLayoutLw(boolean isDefaultDisplay, int displayWidth, int displayHeight,
        ...
        if (isDefaultDisplay) {
            ...
            /* workround for Screen pinning test in CTS @{ */
    ...
    public void notifyCameraLensCoverSwitchChanged(long whenNanos, boolean lensCovered) {
        ...
        if (mCameraLensCoverState == CAMERA_LENS_COVERED &&
            ...
            //SPRD: catche ActivityNotFoundException @{
            try{
                startActivityAsUser(intent, UserHandle.CURRENT_OR_SELF);
            } catch (ActivityNotFoundException e) {
                Slog.w(TAG, "No activity to handle CameraLensCoverSwitchChanged.", e);
            }
            // @}
        }
	...
	//SPRD: Open debug log. change the priority of log from d to v,
	// For the reason of cutting slog
	// if (DEBUG_INPUT) {
    ...
    void launchVoiceAssistWithWakeLock(boolean keyguardActive) {
        ...
        // SPRD: catch ActivityNotFoundException @{
        try {
            startActivityAsUser(voiceIntent, UserHandle.CURRENT_OR_SELF);
        } catch (ActivityNotFoundException e) {
            Slog.w(TAG, "No activity to handle VoiceAssists.", e);
        }
        // @}
        mBroadcastWakeLock.release();
    }
    ...
    BroadcastReceiver mDreamReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //GST_guojiangping modify screenshot 20150914 begin
            } else if ("gst.action.screenshot".equals(intent.getAction())){
            	takeScreenshot();
            //GST_guojiangping modify screenshot 20150914 end
            }
        }
    };
    ...
    public void systemReady() {
        ...
        // SPRD: fixbug378040 bind the KeyaurdService before launcher is started-up.
...
//        return mHasNavigationBar;
    ...
    /* SPRD: ingnore some special key when monkey.*/
    public boolean ignorSpecialKey(int keyCode){
        switch (keyCode) {
