...
import android.os.LoadClassManager;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
        ...
        //SPRD TelephonyRegistrySprd
        Object telephonyRegistrySprd = null;
        ConsumerIrService consumerIr = null;
        AudioService audioService = null;
        MmsServiceBroker mmsService = null;
        // SPRD: 379833 new function of MMI test @{
        boolean engModeFlag = android.os.Debug.isMMITest();
        // @}

        WcnManagerService wcnManager = null; //add for WcnManagerService related to CP2 WCN
        ...
        try {
            ...
            Slog.i(TAG, "Telephony Registry Sprd");
            telephonyRegistrySprd = LoadClassManager.createNewInstance("com.android.server.TelephonyRegistrySprd", context);
            ...
            if (!engModeFlag) {
                ...
                ServiceManager.addService(Context.CONSUMER_IR_SERVICE,
                        consumerIr);
            }
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!engModeFlag) {
                mSystemServiceManager
                        .startService(DeviceStorageMonitorService.class);
            }
            ...
            if (!engModeFlag) {
                if (!disableMedia) {
                    try {
                        ...
                        commonTimeMgmtService = new CommonTimeManagementService(
                                context);
                        ServiceManager.addService("commontime_management",
                                commonTimeMgmtService);
                    } catch (Throwable e) {
                        reportWtf(
                                "starting CommonTimeManagementService service",
                                e);
                    }
                }
                ...
                if (!disableNetwork) {
                    try {
                        ...
                        CertBlacklister blacklister = new CertBlacklister(
                                context);
                    } catch (Throwable e) {
                ...
                if (!disableNonCoreServices) {
                    try {
                        ...
                        ServiceManager.addService(
                                AssetAtlasService.ASSET_ATLAS_SERVICE, atlas);
                    } catch (Throwable e) {
        ...
        //Create WcnManagerService
        try {
            Slog.i(TAG, "WcnManager Service");
            wcnManager = WcnManagerService.create(context);
        } catch (Throwable e) {
            reportWtf("starting NetworkManagement Service", e);
        }
        ...
        //SPRD TelephonyRegistrySprd
        final Object telephonyRegistrySprdF = telephonyRegistrySprd;
	  ...
	  final SecurityService securityF = security;
        ...
        mActivityManagerService.systemReady(new Runnable() {
            ...
            public void run() {
                ...
                //SPRD Add TelephonyRegistrySprd
                try {
                    if (telephonyRegistrySprdF != null) {
                        LoadClassManager.invokeMethod(telephonyRegistrySprdF, "systemRunning");
                    }
                } catch (Throwable e) {
                    reportWtf("Notifying TelephonyRegistrySprd running", e);
                }
                try {
                ...
                /* SPRD: replace this in ams after phone process create @{ */
//                try {
