...
#define CAMERA_ISP_ANTI_FLICKER                      10
#define CAMERA_ISP_RAWAE                             11
...
struct camera_context {
	...
	/*for isp anti-flicker buffer*/
	cmr_uint                 isp_anti_flicker_flag;
	cmr_uint                 isp_anti_flicker_phys_addr;
	cmr_uint                 isp_anti_flicker_virt_addr;
#endif
};
