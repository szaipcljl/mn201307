...
#define PCI_DEVICE_ID_INTEL_BXT_A_UART0	0x0abc
#define PCI_DEVICE_ID_INTEL_BXT_A_UART1	0x0abe
#define PCI_DEVICE_ID_INTEL_BXT_A_UART2	0x0ac0
#define PCI_DEVICE_ID_INTEL_BXT_A_UART3	0x0aee

#define PCI_DEVICE_ID_INTEL_BXT_B_UART0	0x1abc
#define PCI_DEVICE_ID_INTEL_BXT_B_UART1	0x1abe
#define PCI_DEVICE_ID_INTEL_BXT_B_UART2	0x1ac0
#define PCI_DEVICE_ID_INTEL_BXT_B_UART3	0x1aee

#define PCI_DEVICE_ID_INTEL_BXTP_UART0	0x5abc
#define PCI_DEVICE_ID_INTEL_BXTP_UART1	0x5abe
#define PCI_DEVICE_ID_INTEL_BXTP_UART2	0x5ac0
#define PCI_DEVICE_ID_INTEL_BXTP_UART3	0x5aee
...
static inline void calc_for_prv_clk_div(struct uart_port *p, unsigned int baud,
...
static int bxt_serial_init(struct pci_dev *dev)
{
	void __iomem *p;
	unsigned int bar = 0;
	...
	/* Hw reset */
	writel(0, p + BXT_UART_RESET);
	writel(BXT_UART_IDMA_RESET | BXT_UART_HOST_RESET, p + BXT_UART_RESET);
		 ...
		 struct uart_8250_port *port, int idx)
{
	...
	/* clock not gate */
	writel(BXT_UART_IC_CLOCK_IDMA | BXT_UART_IC_CLOCK_UART,
...
static struct pci_serial_quirk pci_serial_quirks[] __refdata = {
	...
	*/
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_A_UART0,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_A_UART1,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_A_UART2,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.setup		= pci_default_setup,
	},
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_A_UART3,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
 	...
 	{
 		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_B_UART0,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_B_UART1,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_B_UART2,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXT_B_UART3,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXTP_UART0,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXTP_UART1,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXTP_UART2,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
	...
	{
		.vendor		= PCI_VENDOR_ID_INTEL,
		.device		= PCI_DEVICE_ID_INTEL_BXTP_UART3,
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.init		= bxt_serial_init,
		.setup		= bxt_serial_setup,
...
/*	{	PCI_VENDOR_ID_KORENIX, PCI_DEVICE_ID_KORENIX_JETCARDF0,
	...
	*/
	...
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_QRK_UART,
		...
		pbn_qrk },
	/* Intel Broxton */
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_A_UART0,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_A_UART1,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },

	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_A_UART2,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_b0_1_115200 },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_A_UART3,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_B_UART0,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_B_UART1,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_B_UART2,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXT_B_UART3,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	/* Intel Broxton-P */
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXTP_UART0,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXTP_UART1,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXTP_UART2,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
	{	PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_BXTP_UART3,
		PCI_ANY_ID,  PCI_ANY_ID, 0, 0,
		pbn_bxt },
