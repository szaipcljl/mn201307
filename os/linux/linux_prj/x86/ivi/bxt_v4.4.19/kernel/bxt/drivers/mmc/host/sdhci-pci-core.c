...
static int bxt_sdio_probe_slot(struct sdhci_pci_slot *slot)
{
	slot->host->mmc->caps |= MMC_CAP_NONREMOVABLE | MMC_CAP_WAIT_WHILE_BUSY;

	return 0;
}

static const struct sdhci_pci_fixes sdhci_intel_bxt_sdio = {
	.quirks2	= SDHCI_QUIRK2_PRESET_VALUE_BROKEN |
			SDHCI_QUIRK2_VDD_1P8_ONLY,
	.allow_runtime_pm = true,
	.probe_slot	= bxt_sdio_probe_slot,
};

static int bxt_sd_probe_slot(struct sdhci_pci_slot *slot)
{
...
static const struct sdhci_pci_fixes sdhci_intel_bxt_sd = {
	.quirks		= SDHCI_QUIRK_NO_ENDATTR_IN_NOPDESC,
	.quirks2	= SDHCI_QUIRK2_CARD_ON_NEEDS_BUS_ON |
			  SDHCI_QUIRK2_PRESET_VALUE_BROKEN |
			  SDHCI_QUIRK2_STOP_WITH_TC,
	.allow_runtime_pm = true,
	.probe_slot	= bxt_sd_probe_slot,
};
...
static const struct pci_device_id pci_ids[] = {
...

	{
		...
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.driver_data	= (kernel_ulong_t)&sdhci_intel_bxt_sdio,
	},

	{
		...
		.subvendor	= PCI_ANY_ID,
		.subdevice	= PCI_ANY_ID,
		.driver_data	= (kernel_ulong_t)&sdhci_intel_bxt_sd,
	},
