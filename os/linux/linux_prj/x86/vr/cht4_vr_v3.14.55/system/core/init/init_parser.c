...
struct service* make_exec_oneshot_service(int nargs, char** args) {
    ...
    struct service* svc = (struct service*) calloc(1, sizeof(*svc) + sizeof(char*) * argc);
    if (svc == NULL) {
